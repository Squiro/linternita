...
title: 'Algunas cosas sobre Windows 95 y el video "piloto"'
authors: [linternita]
tags: [random]
---
...
2. Algunos temas de los cuales me gustaría hablar son difíciles o no funcionan
   ...
   la gracia. Parte de lo que hace interesante ese video es ver cómo las cosas
   funcionan "en vivo".
...
El problema con esto es que Windows 95 es viejo y en algunos casos no sabe qué
hacer con el hardware moderno. Por ejemplo, si tu procesador tiene más de
...
capaz de emular distintos tipos de procesadores, placas de video, lectoras de
CDs, etc, etc.
